  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        <h1 className={styles.title}>Log in with</h1>
        
        <div className={styles.ssoButtons}>
          <button className={styles.ssoBtn} type="button" onClick={handleGoogleLogin}>
            <GoogleIcon /> Google
          </button>
          <button className={styles.ssoBtn} type="button" onClick={handleAppleLogin}>
            <AppleIcon /> Apple
          </button>
        </div>
